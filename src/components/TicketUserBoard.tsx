...
const TicketUserBoard: React.FC<TicketUserBoardProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 h-full max-h-[calc(100vh-250px)]">
      ...
      <div className="flex flex-col h-full min-h-[300px] max-h-full">
        ...
        <ScrollArea className="flex-1 bg-slate-50/30 rounded-b-md p-2 overflow-y-auto">
      ...
      {supportUsers.map(supportUser => (
        <div key={supportUser.id} className="flex flex-col h-full min-h-[300px] max-h-full">
          ...
          <ScrollArea className={`flex-1 rounded-b-md p-2 overflow-y-auto
