  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-[#101F2E]">Gerenciamento de Usuários</h1>
        <div className="flex gap-2">
          <Button variant="outline" onClick={loadUsers} disabled={loading} className="border-[#D5B170]/50 text-[#101F2E]">
            <RefreshCw className={`h-4 w-4 mr-2 ${loading ? 'animate-spin' : ''}`} />
            Atualizar
          </Button>
          <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
            <DialogTrigger asChild>
              <Button className="bg-[#D5B170] hover:bg-[#c4a465] text-[#101F2E]">
            ...
            <DialogContent className="sm:max-w-[425px]">
              ...
              <div className="flex justify-end">
                <Button 
                  ...
                  className="bg-[#D5B170] hover:bg-[#c4a465] text-[#101F2E]"
                >
                  {createLoading ? (
                    <>
                    ...
                    <TableRow key={userItem.id}>
                      ...
                      <TableCell>
                        <span className={`inline-block px-2 py-1 rounded text-xs ${
                          userItem.role === 'admin' 
                            ? 'bg-[#D5B170]/20 text-[#101F2E] font-medium' 
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-1">
                          ...
                          <Button
                            ...
                            disabled={userItem.id === user?.id} // Não permitir excluir o próprio usuário
